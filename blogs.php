...
<div>
    ...
    <section class="page-title" style="background-image:url(images/background/8.jpg)">
    	<div class="auto-container">
			...
			<h1>Blog <span>List</span></h1>
				<h4 class="title pt-2  text-center">Blogs of JD GURUS</h4>
			</div>
        </div>
    </section>
    <!--End Page Title-->
	...
	<section class="about-section-four">
		<div class="auto-container container ">
			...
			<div class="row clearfix" style="row-gap: 20px;">
					...
					<div class="inner-box">
						...
						<div class="lower-content">
							<ul class="post-meta">
								...
								<li><span class="fa  fa-solid fa-message"></span>0</li>
							</ul>
							<h5 class="mb-0"><a href="blog-single.html">Choosing a Payment Gateway: Key Factors to Consider</a></h5>
							<a href="#" class="theme-btn btn-style-eighteen">Read More</a>
						</div>
					</div>
				</div>
				...
				<div class="news-block-four col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							...
							<div class="overlay-box">
								<a href="images/resource/news-13.jpg" data-fancybox="news" data-caption="" class="plus flaticon-plus-symbol"></a>
							</div>
						</div>
						<div class="lower-content">
							<ul class="post-meta">
				...
				<div class="news-block-four col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							...
							<div class="overlay-box">
								<a href="images/resource/news-14.jpg" data-fancybox="news" data-caption="" class="plus flaticon-plus-symbol"></a>
							</div>
						</div>
						<div class="lower-content">
							<ul class="post-meta">
				...
				<div class="news-block-four col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							...
							<div class="overlay-box">
								<a href="images/resource/news-15.jpg" data-fancybox="news" data-caption="" class="plus flaticon-plus-symbol"></a>
							</div>
						</div>
						<div class="lower-content">
							<ul class="post-meta">
